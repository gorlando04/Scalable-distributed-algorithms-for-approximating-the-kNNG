...
np.savetxt(f'/rapids/GPU_KNNG/data/artificial/SK-{N//int(1e6)}M_data.txt', db, delimiter='\t',fmt='%.30f',header=f'{N} 12',comments='')

#np.savetxt(f'SK-{N//int(1e6)}M_data.txt', db, delimiter='\t',fmt='%.30f',header=f'{N} 12',comments='')
